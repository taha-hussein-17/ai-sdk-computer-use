                ...
                case "text":
                  return (
                    ...
                    >
                      <div
                        className={cn(
                          "flex flex-col gap-3 px-4 py-3 rounded-2xl shadow-lg transition-all duration-300",
                          message.role === "user"
                            ? "bg-zinc-100 text-zinc-900 border border-white/20 shadow-white/5 font-medium"
                            : "bg-zinc-800/80 text-zinc-200 border border-zinc-700/50 backdrop-blur-md font-normal leading-relaxed"
                        )}
                      >
                ...
                case "tool-invocation": {
                  ...
                  if (toolName === "computer" || toolName === "bash") {
                    ...
                    if (toolName === "computer") {
                      ...
                      actionDetail = args.command ? `"${args.command}"` : "";
                      ActionIcon = ScrollText;
                    }
                    ...
                    return (
                      ...
                      >
                        ...
                        ) : state === "result" && toolName === "bash" ? (
                          <div className="p-2 bg-zinc-50 dark:bg-zinc-800 rounded-lg font-mono text-xs overflow-x-auto">
                            <pre>{(part as any).toolInvocation.result}</pre>
                          </div>
                        ) : null}
                      </motion.div>
                    );
